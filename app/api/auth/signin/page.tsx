        ...
        <>
            <div className="max-w-sm m-auto h-screen flex items-center px-10 sm:px-0">
                <div className="flex flex-col justify-center items-center gap-5 w-full">
                    ...
                    <form
                        className="items-center flex flex-col gap-5 w-full text-mine-300"
                    ...
                    <form action={async () => {
                        ...
                        <button className="bg-mine-950 hover:bg-mine-500 text-mine-50 rounded-full text-sm pr-4 pl-1 py-1" type="submit" >
